...
<table>
    ...
    <tbody>
    <%--@elvariable id="employees" type="java.util.List<com.opal.persistence.model.Employee>"--%>
...
<form method="post" action="/SpringMVC/employee/add">
...
<br/>
<br/>
<form method="post" action="/SpringMVC/employee/findByName">
...
<br/>
<br/>
<form method="post" action="/SpringMVC/employee/findByNameAndPosition">
...
<br/>
<br/>
<form method="post" action="/SpringMVC/employee/findByNameAndPhone">
